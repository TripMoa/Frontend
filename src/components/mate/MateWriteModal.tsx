...
import "../../styles/mate/MateModals.css";
import { TRANSPORT_OPTIONS, TRAVEL_TYPE_OPTIONS, AGE_GROUP_OPTIONS, GENDER_OPTIONS } from "../../hooks/mate/mate.constants";
...
export function MateWriteModal({
  ...
  selectedGender,
  setSelectedGender,
}: MateWriteModalProps): JSX.Element {
